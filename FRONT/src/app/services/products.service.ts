...
import { Observable } from 'rxjs';  //solo los componentes suscriptos a este servicio podran acceder a los

@Injectable({
  providedIn: 'root'
})
export class ProductsService {
  url: string = 'http://localhost:300/'  //esta ruta corresponderia al json
